                ...
                <div className="bg-[#FFF5F4] mt-16 py-24 gap-8">
                    <div className="flex justify-center md:flex-row flex-col items-center gap-8">
                            <div className="md:max-w-1/3 px-4">
                                ...
                                <p className="text-sm font-extralight">TRADITIONAL FESTIVAL</p>
                                <p className="text-sm font-extralight">
                                ...
                                <p className="text-sm font-extralight">EARLY HISTORY AND SETTLEMENT</p>
                                <p className="text-sm font-extralight">
                    ...
                    <p className="text-md font-extralight mt-8">
                    ...
                    <p className="text-lg  mt-2 ">ETYMOLOGY OF OGIDI</p>
                    ...
                    <p className="text-lg font-extralight mt-2">CULTURE AND TRANSFORMATION</p>
